...
if not META_APP_ID:
    ...
    print("RECOMMENDED: Set META_APP_ID to your Meta App ID for local development.")
if not META_APP_SECRET:
    print("WARNING: META_APP_SECRET environment variable is not set.")
    print("NOTE: This is needed for local Meta authentication with callback server.")
